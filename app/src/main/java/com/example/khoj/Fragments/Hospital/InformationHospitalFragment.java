...
public class InformationHospitalFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.infohospital_layout,container,false);
        ...
        if((closingTime.getText()=="")){
            closingTime.setText("Not Available");
        }
        return view;
    }
